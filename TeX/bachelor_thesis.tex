...
\begin{equation}
	(W)_{i, j}, b_i \sim U\left(- \frac{1}{\sqrt{n}}, + \frac{1}{\sqrt{n}}\right),
\end{equation}
...
Pro stochastický gradientní sestup byl použit řád učení o hodnotě $10^{-2}$,
pro algoritmy AdaGrad, RMSProp i Adam $10^{-3}$.
...
Ze zmíněného obrázku jasně vyplývá, že algoritmus AdaGrad není tak výkonný jako ostatní algoritmy,
mezi nimiž dominují algoritmy RMSProp a Adam.

\begin{figure}
	\centering
	\includegraphics[scale=0.75]{Images/Graphics/sgd_adagrad_rmsprop_adam_mlp_100.png}

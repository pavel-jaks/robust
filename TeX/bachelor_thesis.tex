...
\begin{enumerate}
	...
	\item aktivace vrstva s funkcí softmax.
\end{enumerate}
...
totiž jestli dojde k aplikaci funkce Clip na konci procesu generování adversariálních vzorků
či při každé iteraci algoritmu sign gradient descent.

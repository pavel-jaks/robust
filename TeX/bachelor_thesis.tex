...
of the output prediction. Such prturbated inputs can be called adversarial examples.
...
aby vztvořený vzorek byl blízko benignímu vzorku ve smyslu zvolené $l_p$ normy.

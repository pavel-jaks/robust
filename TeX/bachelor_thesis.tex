...
$F: \mathbb{R}^{n_1, ..., n_k} \rightarrow \mathbb{R}^{m_1, ..., m_l}$.
Pro případ regrese potom $l = 1$, $m = 1$ a výstup $F$ hraje roli predikované hodnoty,
pro případ klasifikace je též $l = 1$,
ale $m$ je rovno počtu tříd a výstup $F$ je predikovanou pravděpodobnostní distribucí,
...
$\phi : \mathbb{R}^{p_1, ..., p_r} \rightarrow \mathbb{R}^{q_1, ..., q_s}$,
...
\begin{equation} \label{dense}
	\phi (u) = W u + b,
\end{equation}
kde $W \in \mathbb{R}^{q_1, p_1}$ je \emph{matice vah} (z angl. \emph{weight})
...
\end{equation}
kde $\phi : \mathbb{R}^{C_{in}, W_{in}, H_{in}} \rightarrow \mathbb{R}^{C_{out}, W_{out}, H_{out}}$
...
$b \in \mathbb{R}^{C_{out}, W_{out}, H_{out}}$ je práh,
$K~\in~\mathbb{R}^{C_{out}, C_{in}, k_1, k_2}$
...
která při aplikaci na obrázek o rozměrech $C \times W \times H$ (počet kanálů, šířka, výška)
v každém kanálu reportuje maximální hodnotu v blocích o rozměrech $k_1 \times k_2$.
Potom zobrazení $\phi$ je zobrazení $\phi:\mathbb{R}^{C, W, H}~\rightarrow~\mathbb{R}^{C, W_{out}, H_{out}}$,
kde platí:
\begin{align}
	W_{out} &= \left\lceil \frac{W}{k_1} \right\rceil, \\
	H_{out} &= \left\lceil \frac{H}{k_2} \right\rceil,
\end{align}
a má předpis $\forall i \in \{1, ..., C\}, \forall j \in \{1, ..., W_{out}\}, \forall k \in \{1, ..., H_{out}\}$:
\begin{equation}
	\phi(u) = \operatorname{max}\{u_{i, \mu, \nu} | (j-1) k_1 < \mu \leq j k_1, (k-1) k_2 < \nu \leq k k_2 \}.
\end{equation}
...
v případě konvolučních vrstev je $n$ rovno součinu počtu vstupních kanálů s součinem rozměrů konvolučních jader.
...
\begin{figure}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/FGSM/ALTERED/fgsm_altered_0.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/FGSM/ALTERED/fgsm_altered_1.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/FGSM/ALTERED/fgsm_altered_2.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/FGSM/ALTERED/fgsm_altered_3.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/FGSM/ALTERED/fgsm_altered_4.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/FGSM/ALTERED/fgsm_altered_5.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/FGSM/ALTERED/fgsm_altered_6.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/FGSM/ALTERED/fgsm_altered_7.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/FGSM/ALTERED/fgsm_altered_8.png}
	\centering
	\caption{FGSM}
\end{figure}

\begin{figure}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/I-FGSM/ALTERED/ifgsm_altered_0.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/I-FGSM/ALTERED/ifgsm_altered_1.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/I-FGSM/ALTERED/ifgsm_altered_2.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/I-FGSM/ALTERED/ifgsm_altered_3.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/I-FGSM/ALTERED/ifgsm_altered_4.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/I-FGSM/ALTERED/ifgsm_altered_5.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/I-FGSM/ALTERED/ifgsm_altered_6.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/I-FGSM/ALTERED/ifgsm_altered_7.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/I-FGSM/ALTERED/ifgsm_altered_8.png}
	\centering
	\caption{I-FGSM}
\end{figure}

\begin{figure}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/PGD/ALTERED/pgd_altered_0.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/PGD/ALTERED/pgd_altered_1.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/PGD/ALTERED/pgd_altered_2.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/PGD/ALTERED/pgd_altered_3.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/PGD/ALTERED/pgd_altered_4.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/PGD/ALTERED/pgd_altered_5.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/PGD/ALTERED/pgd_altered_6.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/PGD/ALTERED/pgd_altered_7.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/PGD/ALTERED/pgd_altered_8.png}
	\centering
	\caption{PGD}
\end{figure}

\begin{figure}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/L-BFGS/ALTERED/lbfgs_altered_0.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/L-BFGS/ALTERED/lbfgs_altered_1.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/L-BFGS/ALTERED/lbfgs_altered_2.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/L-BFGS/ALTERED/lbfgs_altered_3.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/L-BFGS/ALTERED/lbfgs_altered_4.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/L-BFGS/ALTERED/lbfgs_altered_5.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/L-BFGS/ALTERED/lbfgs_altered_6.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/L-BFGS/ALTERED/lbfgs_altered_7.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/L-BFGS/ALTERED/lbfgs_altered_8.png}
	\centering
	\caption{L-BFGS}
\end{figure}

\begin{figure}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/CW/ALTERED/cw_altered_0.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/CW/ALTERED/cw_altered_1.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/CW/ALTERED/cw_altered_2.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/CW/ALTERED/cw_altered_3.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/CW/ALTERED/cw_altered_4.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/CW/ALTERED/cw_altered_5.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/CW/ALTERED/cw_altered_6.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/CW/ALTERED/cw_altered_7.png}
	\includegraphics[scale=0.2]{Images/Graphics/AEXAMPLES/CW/ALTERED/cw_altered_8.png}
	\centering
	\caption{CW}
\end{figure}

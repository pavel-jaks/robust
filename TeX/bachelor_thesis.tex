...
\begin{equation}
	(\exists x, y)(\exists \Delta x, \|\Delta x\| < \kappa)
...
tedy $\kappa$ je poloměr kulového oklolí $x$ v $L^\infty$ normě.
...
například jsou-li vzorky obrázky, funkce $Clip$ zajišťuje i to, aby hodnoty pixelů nebyly záporné či vyšší než 255.
